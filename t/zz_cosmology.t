...
is_within( ALPHA, 1/137.035999139, 2.3e-10, 'fine structure constant to within 2.3e-10');
...
is_within( DENSITY_CRITICAL_RHOc, 3 * $hubble_constant**2 /(8 * PI * GRAVITATIONAL), 0.001,
